---
title: "Two-AI Ping-Pong Adversarial Review with PA-PVP Mini"
...
<CardGroup cols={2}>
  <Card title="confirmed_fixes_ready ✅" icon="circle-check" href="/reference/output-format">
    Fixes from the prior round that survived the current independent review. These have been validated by two separate passes.
  </Card>
  <Card title="challenged_items 🥊" icon="circle-xmark" href="/reference/output-format">
  ...
  <Card title="new_fixes 🆕" icon="circle-plus" href="/reference/output-format">
  ...
  <Card title="conflicts ⚠️" icon="triangle-exclamation" href="/reference/output-format">
