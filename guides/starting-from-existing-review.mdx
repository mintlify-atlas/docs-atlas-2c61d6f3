---
title: "PA-PVP Mini: Start a Review from an Existing Analysis"
sidebarTitle: "Existing Review"
description: "Use PA-PVP Mini to audit an existing review, findings list, or tool output — skip a fresh start and work from what you already have."
---
...
<CardGroup cols={2}>
  <Card title="Previous PA-PVP rounds" icon="rotate" href="/guides/single-ai-mode">
    Output from an earlier PA-PVP Mini session, whether run by you or another person.
  </Card>
  <Card title="Findings lists from colleagues" icon="users" href="/reference/input-blocks">
    Peer review notes, code review comments, or structured feedback from a team member.
  </Card>
  <Card title="Tool output" icon="wrench" href="/reference/input-blocks">
    Linter results, static analysis output, security audit findings, or any structured diagnostic output.
  </Card>
  <Card title="Notes and informal reviews" icon="note-sticky" href="/reference/input-blocks">
