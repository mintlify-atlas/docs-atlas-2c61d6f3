---
title: "PA-PVP Mini Output Format Reference"
sidebarTitle: "Output Format"
description: "Complete reference for the PA-PVP Mini output structure: ROUND header, FINDINGS block fields, MERGE STATUS block, provenance fields, and END OF PROTOCOL marker."
---
...
<ResponseField name="label" type="string" required>
  `INDEPENDENT` in Round 1 for all findings. In Round 2+: `INDEPENDENT` (produced without consulting prior output), `CONFIRMED` (prior finding revalidated), `CHALLENGED` (prior finding rejected or overstated), or `NEW` (not present in prior output).
</ResponseField>
